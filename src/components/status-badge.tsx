...
const tones: Record<string, string> = {
  ...
  pending_am: "bg-amber-500/15 text-amber-300 ring-amber-500/30",
  am_changes: "bg-rose-500/15 text-rose-300 ring-rose-500/30",
  pending_client: "bg-blue-500/15 text-blue-300 ring-blue-500/30",
  client_changes: "bg-rose-500/15 text-rose-300 ring-rose-500/30",
