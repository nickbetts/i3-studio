...
export const PERMISSION_KEYS = [
  ...
  "create_clients",
  "edit_clients",
  "manage_account_managers",
  "manage_client_watchers",
  "manage_client_users",
  "create_tasks",
  "manage_all_tasks",
  "moderate_task_comments",
  "reply_tickets",
  "manage_ticket_status",
  "assign_tickets",
  "manage_time_budgets",
  "manage_service_allocations",
  "upload_designs",
  "upload_design_versions",
  "manage_content_templates",
  "manage_content_items",
  "publish_content",
  "manage_client_types",
  "manage_project_templates",
  "manage_onboarding_flows",
  "view_reports",
] as const;
...
export const users = pgTable("user", {
  ...
  // Freeform per-user overrides, e.g. { tabs: [...], grants: ["reply_tickets"] }.
